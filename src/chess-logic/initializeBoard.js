export default function initializeBoard() {
  ...
  // Queens
  squares[4] = { ...squares[4], piece: "queen", player: 1 };
  squares[60] = { ...squares[60], piece: "queen", player: 2 };

  // Kings
  squares[3] = { ...squares[3], piece: "king", player: 1 };
  squares[59] = { ...squares[59], piece: "king", player: 2 };
